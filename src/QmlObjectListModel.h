...
public:
    ...
    Q_INVOKABLE void setCoordinate(int index,QObject* object,bool isNew = false);

    Q_PROPERTY(QList<QObject*>  getObjectList READ getObjectList )
    ...
    Q_INVOKABLE QObject*    removeOne           (QObject* object) { return removeAt(indexOf(object)); }
    void        insert              (int i, QObject* object);
    void        insert              (int i, QList<QObject*> objects);
    bool        contains            (QObject* object) { return _objectList.indexOf(object) != -1; }
    Q_INVOKABLE         int         indexOf             (QObject* object) { return _objectList.indexOf(object); }
    ...
    QList<QObject*> getObjectList     () { return _objectList; }
