...
enum class MAV_FRAME : uint8_t
{
    ...
    GLOBAL_TERRAIN_ALT_INT=11, /* Global (WGS84) coordinate frame (scaled) with AGL altitude (at the waypoint coordinate). First value / x: latitude in degrees*1E7, second value / y: longitude in degrees*1E7, third value / z: positive altitude in meters with 0 being at ground level in terrain model. | */
...
enum class MAV_RESULT : uint8_t
{
    ...
    COMMAND_LONG_ONLY=7, /* Command is valid, but it is only accepted when sent as a COMMAND_LONG (as it has float values for params 5 and 6). | */
    COMMAND_INT_ONLY=8, /* Command is valid, but it is only accepted when sent as a COMMAND_INT (as it encodes a location in params 5, 6 and 7, and hence requires a reference MAV_FRAME). | */
...
{
    NONE=0, /* None of the fields in HIL_SENSOR have been updated | */
...
{
    NONE=0, /* None of the fields in HIGHRES_IMU have been updated | */
    XACC=1, /* The value in the xacc field has been updated | */
    YACC=2, /* The value in the yacc field has been updated | */
    ...
    PRESSURE_ALT=2048, /* The value in the pressure_alt field has been updated | */
    TEMPERATURE=4096, /* The value in the temperature field has been updated | */
    ALL=65535, /* All fields in HIGHRES_IMU have been updated. | */
};

//! HIGHRES_IMU_UPDATED_FLAGS ENUM_END
constexpr auto HIGHRES_IMU_UPDATED_FLAGS_ENUM_END = 65536;
